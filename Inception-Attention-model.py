...
class ChannelAttentionBlock(nn.Module):
    def __init__(self, in_channels):
        ...
        self.shared_encoder_decoder = SharedEncoderDecoderBlock(in_channels, in_channels)
...
# Example usage:
input_feature_map = torch.randn(1, 1, 256, 256)  # Adjust dimensions based on your actual input

# Sequential Inception-Attention Blocks
model = SequentialInceptionAttentionBlocks(num_blocks=5)
